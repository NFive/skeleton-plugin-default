...
{{ if client }}		{{clientprojectguid}}.Debug|Any CPU.ActiveCfg = Debug|Any CPU
		{{clientprojectguid}}.Debug|Any CPU.Build.0 = Debug|Any CPU
		{{clientprojectguid}}.Release|Any CPU.ActiveCfg = Release|Any CPU
		{{clientprojectguid}}.Release|Any CPU.Build.0 = Release|Any CPU{{ end }}
{{ if server }}		{{serverprojectguid}}.Debug|Any CPU.ActiveCfg = Debug|Any CPU
		{{serverprojectguid}}.Debug|Any CPU.Build.0 = Debug|Any CPU
		{{serverprojectguid}}.Release|Any CPU.ActiveCfg = Release|Any CPU
		{{serverprojectguid}}.Release|Any CPU.Build.0 = Release|Any CPU{{ end }}
{{ if shared }}		{{sharedprojectguid}}.Debug|Any CPU.ActiveCfg = Debug|Any CPU
